...
-- 正在导出表  study.t_sys_dept 的数据：~10 rows (大约)
...
-- 导出  表 study.t_sys_dept_relation 结构
...
-- 正在导出表  study.t_sys_dept_relation 的数据：~0 rows (大约)
...
-- 正在导出表  study.t_sys_dict 的数据：~7 rows (大约)
...
-- 正在导出表  study.t_sys_menu 的数据：~14 rows (大约)
...
-- 正在导出表  study.t_sys_module 的数据：~6 rows (大约)
...
-- 正在导出表  study.t_sys_role 的数据：~3 rows (大约)
...
-- 正在导出表  study.t_sys_role_dept 的数据：~3 rows (大约)
...
-- 正在导出表  study.t_sys_role_menu 的数据：~22 rows (大约)
...
-- 导出  表 study.t_sys_role_menu_permission 结构
...
-- 正在导出表  study.t_sys_role_menu_permission 的数据：~81 rows (大约)
...
-- 正在导出表  study.t_sys_user 的数据：~8 rows (大约)
...
-- 正在导出表  study.t_sys_user_role 的数据：~10 rows (大约)
...
-- 导出  表 study.zipkin_annotations 结构
...
-- 导出  表 study.zipkin_dependencies 结构
